...
import { AppRegistry, StyleSheet, Text, StatusBar, View, ScrollView } from 'react-native';
import { Container, Header, Title, Content, Footer, FooterTab, Button, Icon } from 'native-base';
import Mapbox, { MapView } from 'react-native-mapbox-gl';
import configJson from './ConfigsJson.json';

const accessToken = configJson['mapbox'].key;
Mapbox.setAccessToken(accessToken);
class Semut extends Component {
    state = {
        center: {
